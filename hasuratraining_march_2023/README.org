...
- Setup: data-sources
- Tables and Relationships: data modeling
- Customization: GraphQL API development
- REST Endpoints: REST API development
- Authorization: common area of business logic
- Actions: integration for validation
- Events: integration for side-effects
- Remote Joins and Schema: integration for data
